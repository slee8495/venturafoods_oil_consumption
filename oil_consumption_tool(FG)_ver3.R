...
dsx_1 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.04.01.xlsx")
dsx_2 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.05.02.xlsx")
dsx_3 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.06.01.xlsx")
dsx_4 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.07.05.xlsx")
dsx_5 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.08.01.xlsx")
dsx_6 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.09.02.xlsx")
dsx_7 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.10.03.xlsx")
dsx_8 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.11.01.xlsx")
dsx_9 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.12.01.xlsx")
dsx_10 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.01.03.xlsx")
dsx_11 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.02.02.xlsx")
dsx_12 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.03.01.xlsx")

######################################################### Other List ######################################################

# BoM RM to sku 
rm_to_sku <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 04.26.23.xlsx", 
                        sheet = "RM to SKU")

# BoM Report 
bom <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 04.26.23.xlsx", 
                  sheet = "BoM")
...
sku_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/Apr.2023/shipped.xlsx")

# Input sales orders (Make sure in the MSTR if months info input correct) 
# https://edgeanalytics.venturafoods.com/MicroStrategyLibrary/app/DF007F1C11E9B3099BB30080EF7513D2/7D421DDA4D4411DA73B4469771826BD9/W62--K46
sales_orders <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/Apr.2023/ordered.xlsx")


# Completed SKU List 
completed_sku_list <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/Apr.2023/Completed SKU list (12).xlsx")
...
###### Lag 2 #####
rbind(forecast_lag_2, forecast_1, forecast_2, forecast_3, forecast_4, forecast_5, forecast_6, forecast_7, forecast_8, forecast_9, forecast_10,
      forecast_11, forecast_12) -> forecast2
...
###### Lag 3 #####
rbind(forecast_lag_3, forecast_lag_2, forecast_1, forecast_2, forecast_3, forecast_4, forecast_5, forecast_6, forecast_7, forecast_8, forecast_9, 
      forecast_10, forecast_11, forecast_12) -> forecast3
...
###### Lag 4 #####
rbind(forecast_lag_4, forecast_lag_3, forecast_lag_2, forecast_1, forecast_2, forecast_3, forecast_4, forecast_5, forecast_6, forecast_7, forecast_8, 
      forecast_9, forecast_10, forecast_11, forecast_12) -> forecast4
...
identitied_skus_not_existing %>% 
  ...
  dplyr::mutate(group_no = "n/a",
                ...
                diff_between_forecast_actual = "n/a",
                consumption_percent_adjusted_sales_order = "n/a",
                diff_between_forecast_original = "n/a") %>% 
...
colnames(final_paper)[16] <- "Adjusted Forecast Cases"
colnames(final_paper)[17] <- "Forecasted Oil Qty"
colnames(final_paper)[18] <- "Actual Shipped Cases"
colnames(final_paper)[19] <- "Consumption Quantity (Actual Shipped)"
colnames(final_paper)[20] <- "Consumption % (by Adjusted forecast - Actual Shipped)"
colnames(final_paper)[21] <- "Diff (Forecasted - Actual Shipped)"
colnames(final_paper)[22] <- "Sales Order Qty Final (Cases)"
colnames(final_paper)[23] <- "Sales Order Qty Original (Cases)"
colnames(final_paper)[24] <- "Consumption Quantity (Original Sales Order Qty)"
colnames(final_paper)[25] <- "Consumption % (by Adjusted forecast - Original Sales Order Qty)"
colnames(final_paper)[26] <- "Diff (Forecasted - Original Sales Order)"
