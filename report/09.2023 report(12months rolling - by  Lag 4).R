...
dsx_lag4 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.06.01.xlsx")
dsx_lag3 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.07.05.xlsx")
dsx_lag2 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.08.01.xlsx")
dsx_lag1 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.09.02.xlsx")

dsx_1 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.10.03.xlsx")
dsx_2 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.11.01.xlsx")
dsx_3 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.12.01.xlsx")
dsx_4 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.01.03.xlsx")
dsx_5 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.02.02.xlsx")
dsx_6 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.03.01.xlsx")
dsx_7 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.04.03.xlsx")
dsx_8 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.05.03.xlsx")
dsx_9 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.06.01.xlsx")
dsx_10 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.07.05.xlsx")
dsx_11 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.08.01.xlsx")
dsx_12 <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2023/DSX Forecast Backup - 2023.09.01.xlsx")

######################################################### Other List ######################################################

# BoM RM to sku 
rm_to_sku <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 10.04.23.xlsx", 
                        sheet = "RM to SKU")

# BoM Report 
bom <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) NEW TEMPLATE - 10.04.23.xlsx", 
                  sheet = "BoM")
...
bulk_oil_list <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/Bulk Oil Table.xlsx")
...
sku_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/shipped.xlsx")

# Input sales orders (Make sure in the MSTR if months info input correct) 
# https://edgeanalytics.venturafoods.com/MicroStrategyLibrary/app/DF007F1C11E9B3099BB30080EF7513D2/7D421DDA4D4411DA73B4469771826BD9/W62--K46
sales_orders <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/ordered.xlsx")


# Completed SKU List 
completed_sku_list <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/Completed SKU list - Linda.xlsx")
...
dplyr::rename(mfg_loc = product_manufacturing_location_code,
  ...
  dplyr::mutate(sku = gsub("-", "", sku),
                ...
                mfg_ref = paste0(mfg_loc, "_", sku),
                label = stringr::str_sub(sku, 6, 8)) %>% 
  dplyr::select(forecast_month_year_id, mfg_ref, mfg_loc, sku, sku_description, label, category, platform, group_no, group, adjusted_forecast_cases,
                adjusted_forecast_pounds_lbs) %>% 
  dplyr::mutate(adjusted_forecast_pounds_lbs = replace(adjusted_forecast_pounds_lbs, is.na(adjusted_forecast_pounds_lbs), 0),
...
forecast_7 %>% 
  dplyr::group_by(forecast_month_year_id, mfg_ref, mfg_loc, sku, sku_description, label, category, platform, group_no, group) %>% 
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_7

forecast_7$forecast_month_year_id -> forecast_month_year_code_7
substr(forecast_month_year_code_7, nchar(forecast_month_year_code_7)-1, nchar(forecast_month_year_code_7)) %>% 
  data.frame() %>% 
  cbind(forecast_7) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
...
forecast_8 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_8

forecast_8$forecast_month_year_id -> forecast_month_year_code_8
...
dsx_9 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_id == 202306) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_9 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_9

forecast_9$forecast_month_year_id -> forecast_month_year_code_9
...
dsx_10 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_id == 202307) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_10 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_10

forecast_10$forecast_month_year_id -> forecast_month_year_code_10
...
dsx_11 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_id == 202308) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_11 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_11

forecast_11$forecast_month_year_id -> forecast_month_year_code_11
...
dsx_12 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_id == 202309) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_12 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_12

forecast_12$forecast_month_year_id -> forecast_month_year_code_12
...
forecast_7_1 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_7_1

forecast_7_1$forecast_month_year_id -> forecast_month_year_code_7
substr(forecast_month_year_code_7, nchar(forecast_month_year_code_7)-1, nchar(forecast_month_year_code_7)) %>% 
  data.frame() %>% 
  cbind(forecast_7_1) %>% 
  dplyr::rename(month = ".") %>% 
...
forecast_8_1 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_8_1

forecast_8_1$forecast_month_year_id -> forecast_month_year_code_8
substr(forecast_month_year_code_8, nchar(forecast_month_year_code_8)-1, nchar(forecast_month_year_code_8)) %>% 
  data.frame() %>% 
  cbind(forecast_8_1) %>% 
  dplyr::rename(month = ".") %>% 
...
forecast_9_1 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_9_1

forecast_9_1$forecast_month_year_id -> forecast_month_year_code_9
substr(forecast_month_year_code_9, nchar(forecast_month_year_code_9)-1, nchar(forecast_month_year_code_9)) %>% 
  data.frame() %>% 
  cbind(forecast_9_1) %>% 
  dplyr::rename(month = ".") %>% 
...
forecast_10_1 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_10_1

forecast_10_1$forecast_month_year_id -> forecast_month_year_code_10
substr(forecast_month_year_code_10, nchar(forecast_month_year_code_10)-1, nchar(forecast_month_year_code_10)) %>% 
  data.frame() %>% 
  cbind(forecast_10_1) %>% 
  dplyr::rename(month = ".") %>% 
...
forecast_11_1 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_11_1

forecast_11_1$forecast_month_year_id -> forecast_month_year_code_11
substr(forecast_month_year_code_11, nchar(forecast_month_year_code_11)-1, nchar(forecast_month_year_code_11)) %>% 
  data.frame() %>% 
  cbind(forecast_11_1) %>% 
  dplyr::rename(month = ".") %>% 
...
forecast_lag_2_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_2_2

forecast_lag_2_2$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_2_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_2_2
...
forecast_1_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_1_2

forecast_1_2$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_1_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_1_2


forecast_1_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_1_2
...
forecast_2_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_2_2

forecast_2_2$forecast_month_year_code -> forecast_month_year_code_2
substr(forecast_month_year_code_2, nchar(forecast_month_year_code_2)-1, nchar(forecast_month_year_code_2)) %>% 
  data.frame() %>% 
  cbind(forecast_2_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_2_2


forecast_2_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_2_2
...
forecast_3_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_3_2

forecast_3_2$forecast_month_year_code -> forecast_month_year_code_3
substr(forecast_month_year_code_3, nchar(forecast_month_year_code_3)-1, nchar(forecast_month_year_code_3)) %>% 
  data.frame() %>% 
  cbind(forecast_3_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_3_2



forecast_3_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_3_2
...
forecast_4_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_4_2

forecast_4_2$forecast_month_year_code -> forecast_month_year_code_4
substr(forecast_month_year_code_4, nchar(forecast_month_year_code_4)-1, nchar(forecast_month_year_code_4)) %>% 
  data.frame() %>% 
  cbind(forecast_4_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_4_2



forecast_4_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_4_2
...
forecast_5_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_5_2

forecast_5_2$forecast_month_year_code -> forecast_month_year_code_5
substr(forecast_month_year_code_5, nchar(forecast_month_year_code_5)-1, nchar(forecast_month_year_code_5)) %>% 
  data.frame() %>% 
  cbind(forecast_5_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_5_2


forecast_5_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_5_2
...
forecast_6_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_6_2

forecast_6_2$forecast_month_year_code -> forecast_month_year_code_6
substr(forecast_month_year_code_6, nchar(forecast_month_year_code_6)-1, nchar(forecast_month_year_code_6)) %>% 
  data.frame() %>% 
  cbind(forecast_6_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_6_2

forecast_6_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_6_2
...
forecast_7_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_7_2

forecast_7_2$forecast_month_year_id -> forecast_month_year_code_7
substr(forecast_month_year_code_7, nchar(forecast_month_year_code_7)-1, nchar(forecast_month_year_code_7)) %>% 
  data.frame() %>% 
  cbind(forecast_7_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_7_2


forecast_7_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_7_2
...
forecast_8_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_8_2

forecast_8_2$forecast_month_year_id -> forecast_month_year_code_8
substr(forecast_month_year_code_8, nchar(forecast_month_year_code_8)-1, nchar(forecast_month_year_code_8)) %>% 
  data.frame() %>% 
  cbind(forecast_8_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_8_2


forecast_8_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_8_2
...
forecast_9_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_9_2

forecast_9_2$forecast_month_year_id -> forecast_month_year_code_9
substr(forecast_month_year_code_9, nchar(forecast_month_year_code_9)-1, nchar(forecast_month_year_code_9)) %>% 
  data.frame() %>% 
  cbind(forecast_9_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_9_2


forecast_9_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_9_2
...
forecast_10_2 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_10_2

forecast_10_2$forecast_month_year_id -> forecast_month_year_code_10
substr(forecast_month_year_code_10, nchar(forecast_month_year_code_10)-1, nchar(forecast_month_year_code_10)) %>% 
  data.frame() %>% 
  cbind(forecast_10_2) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_10_2


forecast_10_2 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_10_2
...
forecast_lag_3_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_3_3

forecast_lag_3_3$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_3_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_3_3


forecast_lag_3_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_lag_3_3
...
forecast_lag_2_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_2_3

forecast_lag_2_3$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_2_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_2_3
...
forecast_1_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_1_3

forecast_1_3$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_1_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_1_3


forecast_1_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_1_3
...
forecast_2_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_2_3

forecast_2_3$forecast_month_year_code -> forecast_month_year_code_2
substr(forecast_month_year_code_2, nchar(forecast_month_year_code_2)-1, nchar(forecast_month_year_code_2)) %>% 
  data.frame() %>% 
  cbind(forecast_2_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_2_3


forecast_2_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_2_3
...
forecast_3_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_3_3

forecast_3_3$forecast_month_year_code -> forecast_month_year_code_3
substr(forecast_month_year_code_3, nchar(forecast_month_year_code_3)-1, nchar(forecast_month_year_code_3)) %>% 
  data.frame() %>% 
  cbind(forecast_3_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_3_3



forecast_3_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_3_3
...
forecast_4_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_4_3

forecast_4_3$forecast_month_year_code -> forecast_month_year_code_4
substr(forecast_month_year_code_4, nchar(forecast_month_year_code_4)-1, nchar(forecast_month_year_code_4)) %>% 
  data.frame() %>% 
  cbind(forecast_4_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_4_3



forecast_4_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_4_3
...
forecast_5_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_5_3

forecast_5_3$forecast_month_year_code -> forecast_month_year_code_5
substr(forecast_month_year_code_5, nchar(forecast_month_year_code_5)-1, nchar(forecast_month_year_code_5)) %>% 
  data.frame() %>% 
  cbind(forecast_5_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_5_3


forecast_5_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_5_3
...
dsx_6 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_code == 202306) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_6_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_6_3

forecast_6_3$forecast_month_year_code -> forecast_month_year_code_6
substr(forecast_month_year_code_6, nchar(forecast_month_year_code_6)-1, nchar(forecast_month_year_code_6)) %>% 
  data.frame() %>% 
  cbind(forecast_6_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_6_3

forecast_6_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_6_3
...
forecast_7_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_7_3

forecast_7_3$forecast_month_year_id -> forecast_month_year_code_7
substr(forecast_month_year_code_7, nchar(forecast_month_year_code_7)-1, nchar(forecast_month_year_code_7)) %>% 
  data.frame() %>% 
  cbind(forecast_7_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_7_3


forecast_7_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_7_3
...
forecast_8_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_8_3

forecast_8_3$forecast_month_year_id -> forecast_month_year_code_8
substr(forecast_month_year_code_8, nchar(forecast_month_year_code_8)-1, nchar(forecast_month_year_code_8)) %>% 
  data.frame() %>% 
  cbind(forecast_8_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_8_3


forecast_8_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_8_3
...
forecast_9_3 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_9_3

forecast_9_3$forecast_month_year_id -> forecast_month_year_code_9
substr(forecast_month_year_code_9, nchar(forecast_month_year_code_9)-1, nchar(forecast_month_year_code_9)) %>% 
  data.frame() %>% 
  cbind(forecast_9_3) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_9_3


forecast_9_3 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_9_3
...
forecast_lag_4_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_4_4

forecast_lag_4_4$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_4_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_4_4


forecast_lag_4_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_lag_4_4
...
forecast_lag_3_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_3_4

forecast_lag_3_4$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_3_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_3_4


forecast_lag_3_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_lag_3_4
...
forecast_lag_2_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_lag_2_4

forecast_lag_2_4$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_lag_2_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_lag_2_4


forecast_lag_2_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_lag_2_4
...
forecast_1_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_1_4

forecast_1_4$forecast_month_year_code -> forecast_month_year_code_1
substr(forecast_month_year_code_1, nchar(forecast_month_year_code_1)-1, nchar(forecast_month_year_code_1)) %>% 
  data.frame() %>% 
  cbind(forecast_1_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_1_4


forecast_1_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_1_4
...
forecast_2_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_2_4

forecast_2_4$forecast_month_year_code -> forecast_month_year_code_2
substr(forecast_month_year_code_2, nchar(forecast_month_year_code_2)-1, nchar(forecast_month_year_code_2)) %>% 
  data.frame() %>% 
  cbind(forecast_2_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_2_4


forecast_2_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_2_4
...
forecast_3_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_3_4

forecast_3_4$forecast_month_year_code -> forecast_month_year_code_3
substr(forecast_month_year_code_3, nchar(forecast_month_year_code_3)-1, nchar(forecast_month_year_code_3)) %>% 
  data.frame() %>% 
  cbind(forecast_3_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_3_4



forecast_3_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_3_4
...
forecast_4_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_4_4

forecast_4_4$forecast_month_year_code -> forecast_month_year_code_4
substr(forecast_month_year_code_4, nchar(forecast_month_year_code_4)-1, nchar(forecast_month_year_code_4)) %>% 
  data.frame() %>% 
  cbind(forecast_4_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_4_4



forecast_4_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_4_4
...
forecast_5_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_5_4

forecast_5_4$forecast_month_year_code -> forecast_month_year_code_5
substr(forecast_month_year_code_5, nchar(forecast_month_year_code_5)-1, nchar(forecast_month_year_code_5)) %>% 
  data.frame() %>% 
  cbind(forecast_5_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_5_4


forecast_5_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_5_4
...
dsx_6 %>% 
  ...
  readr::type_convert() %>% 
  data.frame() %>% 
  dplyr::filter(forecast_month_year_code == 202307) %>%    ############################# MAKE SURE TO PUT THE DATE CORRECTLY ####################### ----
dplyr::rename(mfg_loc = product_manufacturing_location_code,
              location = location_no,
              sku = product_label_sku_code,
              sku_description = product_label_sku_name,
...
forecast_6_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_code, 1, 4)) -> forecast_6_4

forecast_6_4$forecast_month_year_code -> forecast_month_year_code_6
substr(forecast_month_year_code_6, nchar(forecast_month_year_code_6)-1, nchar(forecast_month_year_code_6)) %>% 
  data.frame() %>% 
  cbind(forecast_6_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_code) %>% 
  dplyr::relocate(year, month) -> forecast_6_4

forecast_6_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_6_4
...
forecast_7_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_7_4

forecast_7_4$forecast_month_year_id -> forecast_month_year_code_7
substr(forecast_month_year_code_7, nchar(forecast_month_year_code_7)-1, nchar(forecast_month_year_code_7)) %>% 
  data.frame() %>% 
  cbind(forecast_7_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_7_4


forecast_7_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_7_4
...
forecast_8_4 %>% 
  ...
  dplyr::summarise(adjusted_forecast_cases = sum(adjusted_forecast_cases),
                   adjusted_forecast_pounds_lbs = sum(adjusted_forecast_pounds_lbs)) %>% 
  dplyr::mutate(year = stringr::str_sub(forecast_month_year_id, 1, 4)) -> forecast_8_4

forecast_8_4$forecast_month_year_id -> forecast_month_year_code_8
substr(forecast_month_year_code_8, nchar(forecast_month_year_code_8)-1, nchar(forecast_month_year_code_8)) %>% 
  data.frame() %>% 
  cbind(forecast_8_4) %>% 
  dplyr::rename(month = ".") %>% 
  dplyr::select(-forecast_month_year_id) %>% 
  dplyr::relocate(year, month) -> forecast_8_4


forecast_8_4 %>% 
  dplyr::filter(mfg_loc != 22) %>% 
  dplyr::filter(mfg_loc != 16) -> forecast_8_4
...
writexl::write_xlsx(identitied_skus_not_existing, "Identitied skus not existing_Sep_2023.xlsx")
...
# Export to Excel File ----
writexl::write_xlsx(final_paper, "oil_consumption_comparison_Sep_2023.xlsx")
...
file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Oil Consumption/venturafoods_oil_consumption/Identitied skus not existing_Sep_2023.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/Identitied skus not existing_Sep_2023.xlsx")

# move oil file
file.rename(from="C:/Users/slee/OneDrive - Ventura Foods/Stan/R Codes/Projects/Oil Consumption/venturafoods_oil_consumption/oil_consumption_comparison_Sep_2023.xlsx",
            to="C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/12 month rolling report/2023. 9 Lag 4/oil_consumption_comparison_Sep_2023.xlsx")
